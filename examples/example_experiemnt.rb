  ...
  module Examples
    class SimulationExample
      def self.run
        ...
        str_template = Core::Statblock.new(name: "Str-Template", strength: 16, dexterity: 10, constitution: 10, hit_die: "d10", level: 1)
        dex_template = Core::Statblock.new(name: "Dex-Template", strength: 10, dexterity: 16, constitution: 10, hit_die: "d10", level: 1)

        str_combatant_one = Core::Character.new(name: "Str-Combatant-One", statblock: str_template, attacks: [str_attack])
        str_combatant_two = Core::Character.new(name: "Str-Combatant-Two", statblock: str_template, attacks: [str_attack])
