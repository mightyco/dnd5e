...
def create_str_shield(level)
  ...
  armor = Dnd5e::Core::Armor.new(name: armor_name, base_ac: base_ac, type: :heavy, max_dex_bonus: 0,
...
def create_str_greatsword(level)
  ...
  greatsword = Dnd5e::Core::Attack.new(name: 'Greatsword', damage_dice: Dnd5e::Core::Dice.new(2, 6),
...
def create_dex_shield(level)
  armor = if level >= 5
            Dnd5e::Core::Armor.new(name: 'Breastplate', base_ac: 14, type: :medium, max_dex_bonus: 2)
          else
            Dnd5e::Core::Armor.new(name: 'Studded Leather', base_ac: 12, type: :light, max_dex_bonus: nil)
          end
  shield = Dnd5e::Core::Armor.new(name: 'Shield', base_ac: 2, type: :shield)
