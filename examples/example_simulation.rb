  ...
  module Core
    class ExampleTeamCombat
      def initialize
        ...
        # Create combat with the SimulationCombatResultHandler
        @combat = TeamCombat.new(teams: [heroes, goblins], result_handler: SimulationCombatResultHandler.new)
      end
...
runner = Dnd5e::Simulation::Runner.new(Dnd5e::Core::ExampleTeamCombat, num_simulations: 1000)
