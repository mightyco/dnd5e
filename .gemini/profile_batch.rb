...
builder = Dnd5e::Builders::CharacterBuilder.new(name: 'Hero').as_barbarian(level: 5, subclass: :berserker, abilities: { strength: 18, constitution: 14 })
hero = builder.build
...
puts "Profiling 100 simulations with 12 Goblins..."
