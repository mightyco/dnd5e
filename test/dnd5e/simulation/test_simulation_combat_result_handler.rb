    ...
    class TestSimulationCombatResultHandler < Minitest::Test
      ...
      def test_report
        ...
        5.times do
          ...
          hero1 = Builders::CharacterBuilder.new(name: 'Hero1')
                                            .with_statblock(Core::Statblock.new(name: 'Hero Statblock', strength: 16,
                                                                                dexterity: 10, constitution: 15, hit_die: 'd10', level: 3).deep_copy)
                                            .with_attack(Core::Attack.new(name: 'Sword',
                                                                          damage_dice: Core::Dice.new(1, 8), relevant_stat: :strength))
                                            .build
          hero2 = Builders::CharacterBuilder.new(name: 'Hero2')
                                            .with_statblock(Core::Statblock.new(name: 'Hero Statblock', strength: 16,
                                                                                dexterity: 10, constitution: 15, hit_die: 'd10', level: 3).deep_copy)
                                            ...
                                            .build
          goblin1 = Builders::MonsterBuilder.new(name: 'Goblin1')
                                            .with_statblock(Core::Statblock.new(name: 'Goblin Statblock', strength: 8,
                                                                                dexterity: 14, constitution: 10, hit_die: 'd6', level: 1).deep_copy)
                                            .with_attack(Core::Attack.new(name: 'Bite',
                                                                          damage_dice: Core::Dice.new(1, 6), relevant_stat: :dexterity))
                                            .build
          goblin2 = Builders::MonsterBuilder.new(name: 'Goblin2')
                                            .with_statblock(Core::Statblock.new(name: 'Goblin Statblock', strength: 8,
                                                                                dexterity: 14, constitution: 10, hit_die: 'd6', level: 1).deep_copy)
