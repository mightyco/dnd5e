    ...
    class TestTeam < Minitest::Test
      def setup
        ...
        @goblin1 = Builders::MonsterBuilder.new(name: 'Goblin1')
                                           .with_statblock(Statblock.new(name: 'Goblin Statblock', strength: 8,
                                                                         dexterity: 14, constitution: 10, hit_die: 'd6', level: 1))
                                           .with_attack(Attack.new(name: 'Bite', damage_dice: Dice.new(1, 6),
